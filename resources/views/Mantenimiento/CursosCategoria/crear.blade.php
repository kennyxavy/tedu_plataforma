...
<div class="row">
    ...
    <div class="card card-primary">
        ...
        <form  role="form" method="POST" action="{{ route('categoriacursos.crear.nuevo')}}">
          @csrf
          <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="input-group-prepend">
                                ...
                                <input type="text" class="form-control" id="nombre" name="nombre" value="{{ old('nombre') }}" placeholder="Ingrese nombre de la categoria" maxlength="30" required>
