...
@endsection
@section('titulo')
Mis datos - <strong>{{Auth()->user()->micodigo}}</strong>
@endsection
...
<div class="row justify-content-center">
    ...
    <div class="card card-primary">
        ...
        <form  role="form" method="POST" action="{{ route('usuarios.actualizar2')}}">
          @csrf
          <div class="card-body">
                ...
                <div class="col-sm-12">
                    <div class="row">
                        <div class="col-sm-2">
                            ...
                            {!! $errors->first('micodigo','<span class="help-block text-danger">:message</span>') !!}
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="far fa-address-card"></i></span>
                                </div>
                                    <input type="text" class="form-control" id="micodigo" name="micodigo" value="{{$datos->micodigo}}" placeholder="" readonly>
                            </div>
                        </div>
                        <div class="col-sm-3">
                        ...
                        <div class="col-sm-3">
                            ...
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    ...
                                    <input type="date" class="form-control" id="nace" name="nace" value="{{ $datos->fnacimiento }}" placeholder="Nacimiento">
                            </div>
                        </div>
                    </div> 
                        ...
                        <div class="col-sm-7">
                            ...
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    ...
                                    <input type="text" class="form-control" id="direccion" name="direccion" value="{{$datos->direccion}}" placeholder="" >
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            ...
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    ...
                                    <input type="text" class="form-control" id="mentor" name="mentor" value="{{$datos->codmentor}}" placeholder="Cod. Referido" >
                            </div>
                        </div>
                        <div class="col-sm-3">
                            ...
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    ...
                                    <input type="text" class="form-control" id="telefono" name="telefono" value="{{$datos->celular}}" placeholder="" >
                            </div>
                        </div>
                        <div class="col-sm-3">
                        ...
                        <div class="col-sm-3">
                            ...
                            {!! $errors->first('nacionalidad','<span class="help-block text-danger">:message</span>') !!}
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="far fa-address-card"></i></span>
                                </div>
                                    <input type="text" class="form-control" id="nacionalidad" name="nacionalidad" value="{{$datos->nacionalidad}}" placeholder="" >
                            </div>
                        </div> 
                        ...
                        <div class="col-sm-3">
                            ...
                            {!! $errors->first('tipocuenta','<span class="help-block text-danger">:message</span>') !!}
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="far fa-address-card"></i></span>
                                </div>
                                    <input type="text" class="form-control" id="tipocuenta" name="tipocuenta" value="{{$datos->tipocuenta}}" placeholder="" >
                            </div>
                        </div> 
                        ...
                        <div class="col-sm-3">
                            ...
                            {!! $errors->first('ncuenta','<span class="help-block text-danger">:message</span>') !!}
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="far fa-address-card"></i></span>
                                </div>
                                    <input type="text" class="form-control" id="ncuenta" name="ncuenta" value="{{$datos->numerocuenta}}" placeholder="" >
                            </div>
                        </div> 
                        ...
                        <div class="col-sm-3">
                            ...
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    ...
                                    <input type="text" class="form-control" id="banco" name="banco" value="{{$datos->banco}}" placeholder="" >
                            </div>
                        </div> 
