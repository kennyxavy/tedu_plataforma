...
<h1 class="title p-1 fs-1" align="center">Indice de Módulos del Curso de Seguros <span class="text-danger">TEDÜ<span /></h1>
  ...
  <div class="container" id="si">
    <div class="list-group list-group-flush">
      ...
      <a href="{{ $url ? $url : "https://academia.teduemprende.com/course/view.php?id=18#section-0"}} class="list-group-item list-group-item-action list-group-item-info">Módulo 1: Generalidades</a>
      <a href="{{ $url ? $url: "https://academia.teduemprende.com/course/view.php?id=18#section-0"}}
        class="list-group-item list-group-item-action list-group-item-info">Módulo 2: Ejemplos de negocios.</a>
      <a href="{{ $url ? $url: "https://academia.teduemprende.com/course/view.php?id=18#section-0"}} class="list-group-item list-group-item-action list-group-item-info">Módulo 3: TEDU SEGUROS</a>
