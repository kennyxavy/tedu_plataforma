...
<head>
    ...
    <title>Curso de Referencias TEDÜ</title>
</head>
<!-- TOP NAV -->
...
<h1 class="title p-1 fs-1" align="center">Indice de Módulos del Curso de Referencias <span
...
{{-- <div class="container" id="si">
    <div class="list-group list-group-flush">
        ...
        <a href="{{ $url ? $url : '' }}" class="list-group-item list-group-item-action list-group-item-info">Módulo 1:
            Generalidades</a>
        <a href="{{ $url ? $url : '' }}" class="list-group-item list-group-item-action list-group-item-info">Módulo 2:
            Ejemplos de negocios</a>
        <a href="{{ $url ? $url : '' }}" class="list-group-item list-group-item-action list-group-item-info">Módulo 3:
            TEDU SOCIOS</a>
    </div>
</div> --}}
...
<script src="{{ asset('/js/countdown_travel.js') }}"></script>
