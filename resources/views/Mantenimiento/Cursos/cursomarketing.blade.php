...
<h1 class="title p-1 fs-1" align="center">Indice de Módulos del Curso de Marketing <span class="text-danger">TEDÜ<span /></h1>
  ...
  <div class="container" id="si">
    <div class="list-group list-group-flush">
      ...
      <a href="{{ $url ? $url: "https://academia.teduemprende.com/course/view.php?id=23#section-2" }}" class="list-group-item list-group-item-action list-group-item-info">Módulo 1: Fundamentos y conceptos del marketing</a>
      <a href="{{ $url ? $url: "https://academia.teduemprende.com/course/view.php?id=23#section-3" }}"
      ...
      <a href="{{ $url ? $url: "https://academia.teduemprende.com/course/view.php?id=23#section-4" }}" class="list-group-item list-group-item-action list-group-item-info">Módulo 3: Paradigmas y enfoques del marketing..</a>
      <a href="{{ $url ? $url: "https://academia.teduemprende.com/course/view.php?id=23#section-5" }}"
        ...
        <a href="{{ $url ? $url: "https://academia.teduemprende.com/course/view.php?id=23#section-6" }}"
        ...
        <a href="{{ $url ? $url: "https://academia.teduemprende.com/course/view.php?id=23#section-7" }}"
        ...
        <a href="{{ $url ? $url: "https://academia.teduemprende.com/course/view.php?id=23#section-8" }}"
