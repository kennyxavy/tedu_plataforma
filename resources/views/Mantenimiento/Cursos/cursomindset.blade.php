...
<h1 class="title p-1 fs-1" align="center">Indice de Módulos del Curso de Mindset <span class="text-danger">TEDÜ<span /></h1>
  ...
  <div class="container" id="si">
    <div class="list-group list-group-flush">
      ...
      <a href="{{ $url ? $url: "#" }}" class="list-group-item list-group-item-action list-group-item-info">Módulo1: Mentalidad ganadora</a>
        <a href="{{ $url ? $url: "" }}" class="list-group-item list-group-item-action list-group-item-info">Módulo 2: Fortaleza interior y felicidad</a>
      <a href="{{ $url ? $url: "" }}" class="list-group-item list-group-item-action list-group-item-info">Módulo 3: Hábitos saludables</a>
      <a href="{{ $url ? $url: "" }}" class="list-group-item list-group-item-action list-group-item-info">Módulo 4: Manejo del dinero</a>
        <a href="{{ $url ? $url: "" }}" class="list-group-item list-group-item-action list-group-item-info">Módulo 5: El arte de hacer dinero</a>
        <a href="{{ $url ? $url: "" }}" class="list-group-item list-group-item-action list-group-item-info">Módulo 6: Libertad financiera</a>
