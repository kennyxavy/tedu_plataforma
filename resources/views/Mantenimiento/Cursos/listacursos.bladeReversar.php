...
<h1 class="title p-1 pb-4 fs-1" align="center" style="display: block; ">Cursos <span class="text-danger">Base</span ></h1>

 <div class="first__paragraph pl-4 pr-4">
        <p class="text-left">"Cursos que conforman la BASE de conocimientos indispensables para realizar negocios digitales. Se recomienda completarlos para garantizar el resultado deseado en el negocio que decida emprender. Al completar tareas recibirán la retroalimentación de un experto del tema para enriquecer su desarrollo personal."</p>
    </div>
...
<section class="academy" id="academy">
	...
	<div class="box">
            <div class="imgBx">
            <img src="{{asset('/images/EMPRENDIMIENTO_TEDU.jpg')}}" width="400px" height="250px"  alt="image1">
            </div>
            <div class="text">
                <div class="main-container">
                    <button type="button" class="btn btn-danger"
	...
	<div class="box">
 	...
 	<div class="box">
	  ...
	  <div class="box">
            <div class="imgBx">
                  <img src="{{asset('/images/Redes Sociales_TEDU.jpg')}}" width="400px" height="250px"  alt="image1">
            </div>
            <div class="text">
                <div class="main-container">
                    <button type="button" class="btn btn-danger"
...
<h1 class="title p-1 pb-4 fs-1" style="display: block; " align="center">Cursos <span class="text-danger">Negocios</span></h1>


  
    <div class="first__paragraph">
        <p class="text-left">"Bienvenidos a disfrutar de todas las opciones de negocios que los miembros de TEDÜ pueden implementar. El modelo de estudio incluye lanzamientos permanentes con el conocimiento más nuevo e innovador disponible que permitirá tener el impacto que un negocio exitoso requiere."</p>
    </div>
...
<section class="academy" id="academy">
	...
	<div class="box">
        ...
        <div class="box">
            <div class="imgBx">
                  <img src="{{asset('/images/INMOBILIARIOS_TEDU.jpg')}}" width="400px" height="250px"  alt="image1">
            </div>
            <div class="text">
                <div class="main-container">
                    <button type="button" class="btn btn-danger"
        ...
        <div class="box">
            <div class="imgBx">
                  <img src="{{asset('/images/MARKETPLACE_TEDU.jpg')}}" width="400px" height="250px"  alt="image1">
            </div>
            <div class="text">
                <div class="main-container">
                    <button type="button" class="btn btn-danger"
        ...
        <div class="box">
            <div class="imgBx">
                  <img src="{{asset('/images/BLOCKCHAIN_TEDU.jpg')}}" width="400px" height="250px"  alt="image1">
            </div>
            <div class="text">
                <div class="main-container">
                    <button type="button" class="btn btn-danger"
        ...
        <div class="box">
            <div class="imgBx">
                  <img src="{{asset('/images/INTELIGENCIA ARTIFICIAL_TEDU.jpg')}}" width="400px" height="250px"  alt="image1">
            </div>
            <div class="text">
                <div class="main-container">
                    <button type="button" class="btn btn-danger"
