...
<div><h4>Saldo a la fecha: $ {{session('saldoCuenta')}}</h4></div>
                        ...
                        <div class="col-sm-3">
                            ...
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    ...
                                    <input type="text" class="form-control" id="saldo" name="saldo" value={{session('saldoCuenta')}} placeholder=""  readonly>
                            </div>
                        </div>
