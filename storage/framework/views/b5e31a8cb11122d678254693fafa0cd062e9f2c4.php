...
Mis datos - <strong><?php echo e(Auth()->user()->micodigo); ?></strong>
<?php $__env->stopSection(); ?>
...
<div class="row justify-content-center">
    ...
    <div class="card card-primary">
        ...
        <form  role="form" method="POST" action="<?php echo e(route('usuarios.actualizar2')); ?>">
          <?php echo csrf_field(); ?>
          <div class="card-body">
            <div class="form-group">                
                <div class="col-sm-12">
                    <div class="row">
                        <div class="col-sm-2">
                            <label for="micodigo">Código</label>
                            <?php echo $errors->first('micodigo','<span class="help-block text-danger">:message</span>'); ?>

                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="far fa-address-card"></i></span>
                                </div>
                                    <input type="text" class="form-control" id="micodigo" name="micodigo" value="<?php echo e($datos->micodigo); ?>" placeholder="" readonly>
                            </div>
                        </div>
                        <div class="col-sm-3">
                        ...
                        <div class="col-sm-3">
                            ...
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    ...
                                    <input type="date" class="form-control" id="nace" name="nace" value="<?php echo e($datos->fnacimiento); ?>" placeholder="Nacimiento">
                            </div>
                        </div>
                    </div> 
                        ...
                        <div class="col-sm-7">
                            ...
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    ...
                                    <input type="text" class="form-control" id="direccion" name="direccion" value="<?php echo e($datos->direccion); ?>" placeholder="" >
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            ...
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    ...
                                    <input type="text" class="form-control" id="mentor" name="mentor" value="<?php echo e($datos->codmentor); ?>" placeholder="Cod. Referido" >
                            </div>
                        </div>
                        <div class="col-sm-3">
                            ...
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    ...
                                    <input type="text" class="form-control" id="telefono" name="telefono" value="<?php echo e($datos->celular); ?>" placeholder="" >
                            </div>
                        </div>
                        <div class="col-sm-3">
                        ...
                        <div class="col-sm-3">
                            ...
                            <?php echo $errors->first('nacionalidad','<span class="help-block text-danger">:message</span>'); ?>

                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="far fa-address-card"></i></span>
                                </div>
                                    <input type="text" class="form-control" id="nacionalidad" name="nacionalidad" value="<?php echo e($datos->nacionalidad); ?>" placeholder="" >
                            </div>
                        </div> 
                        ...
                        <div class="col-sm-3">
                            ...
                            <?php echo $errors->first('tipocuenta','<span class="help-block text-danger">:message</span>'); ?>

                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="far fa-address-card"></i></span>
                                </div>
                                    <input type="text" class="form-control" id="tipocuenta" name="tipocuenta" value="<?php echo e($datos->tipocuenta); ?>" placeholder="" >
                            </div>
                        </div> 

                        <div class="col-sm-3">
                            <label for="ncuenta">Número cuenta</label> 

                            <?php echo $errors->first('ncuenta','<span class="help-block text-danger">:message</span>'); ?>

                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="far fa-address-card"></i></span>
                                </div>
                                    <input type="text" class="form-control" id="ncuenta" name="ncuenta" value="<?php echo e($datos->numerocuenta); ?>" placeholder="" >
                            </div>
                        </div> 
                        ...
                        <div class="col-sm-3">
                            ...
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    ...
                                    <input type="text" class="form-control" id="banco" name="banco" value="<?php echo e($datos->banco); ?>" placeholder="" >
                            </div>
                        </div> 
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('themes/lte/layaout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\teduprincipal - proyecto_pruebas\resources\views\Mantenimiento\Usuarios\misdatos.blade.php ENDPATH**/ ?>