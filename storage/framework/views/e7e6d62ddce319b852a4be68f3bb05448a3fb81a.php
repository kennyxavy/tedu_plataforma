...
<head>
  ...
  <link rel="icon" href="<?php echo e(asset('/images/TEDU-ICO.ico')); ?>">
   ...
   <title>Curso Contenidos  TEDÜ</title>
</head>
  <!-- TOP NAV -->
...
<h1 class="title p-1 fs-1" align="center">Indice de Módulos del Curso de Contenidos <span class="text-danger">TEDÜ<span /></h1>
  ...
  <div class="container" id="si">
    <div class="list-group list-group-flush">
      ...
      <a href="<?php echo e($url ? $url: ""); ?>" class="list-group-item list-group-item-action list-group-item-info">Módulo 3: HOTMART</a>
...
</html><?php /**PATH C:\xampp\htdocs\teduprincipal - proyecto_pruebas\resources\views\Mantenimiento\Cursos\cursocontenidos.blade.php ENDPATH**/ ?>