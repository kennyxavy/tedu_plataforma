...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('main/css/owl.carousel.min.css')); ?>">
    <!-- <link rel="stylesheet" href="css/owl.theme.default.min.css"> -->
    <link rel="stylesheet" href="<?php echo e(asset('main/css/owl.theme.default.min.css')); ?>">
    <link href='https://unpkg.com/boxicons@2.1.1/css/boxicons.min.css' rel='stylesheet'>
    <!-- <link rel="stylesheet" href="/css/login_tedu.css"> -->
    <!-- <link rel="stylesheet" href="<?php echo e(asset('main/css/login_tedu.css')); ?>"> -->
    ...
    <!-- <link rel="icon" href="<?php echo e(asset('assets/lte/dist/img/TEDU-ICO.ico')); ?>"> -->
    <link rel="icon" href="<?php echo e(asset('main/images/TEDU-ICO.ico')); ?>">
...
<body>
    <div class="registration-form">
        <div class="text-center">
            <img class="modal-img" src="<?php echo e(asset('images/logo.png')); ?>">
        </div>
        <div class="body">
            <div class="content active" id="signin">
                ...
                <!-- <form action="#"> -->
                <form action="<?php echo e(route('login')); ?>" method="post" role="form" id="form-login">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class=" form-control input-elem" placeholder="Correo electronico"
                            id="email" name="email" <?php $__errorArgs = ['email'];
...
unset($__errorArgs, $__bag); ?> required
                        ...
                        <?php echo $errors->first('password', '<span class="help-block text-danger">:message</span>'); ?>
                    ...
                    <div class="agreements">
                        <?php if(Route::has('password.request')): ?>
                            ...
                            <label for="rem_pass" class="mesage">¿Olvidaste tu contraseña?
                                <a href="<?php echo e(route('password.request')); ?>" class="stretched-link">
                                    Clic aquí.</a>
                    ...
                    <label for="rem_pass" class="mesage">¿Primera vez en TEDÜ?
                        <a href="<?php echo e(route('register')); ?>" class="stretched-link">
                            Regístrate.</a>
...
<?php /**PATH C:\xampp\htdocs\teduprincipal - proyecto_pruebas\resources\views\auth\login.blade.php ENDPATH**/ ?>