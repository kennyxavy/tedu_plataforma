...
<head>
  ...
  <link rel="icon" href="<?php echo e(asset('/images/TEDU-ICO.ico')); ?>">
   ...
   <title>Curso	Blockchain TEDÜ</title>
</head>
  <!-- TOP NAV -->
...
<div class="container justify-content-left">
       <div class="container justify-content-left">
        <a class="navbar-brand" href="/public/home">
            <!-- <img onclick="location.href='/public/listacursos';" src="/img/TEDU-ICO.ico" class="img-fluid" alt="Logo"
...
<h1 class="title p-1 fs-1" align="center">Indice de Módulos del Curso de Blockchain<span class="text-danger">TEDÜ<span /></h1>
  ...
  <div class="container" id="si">
    <div class="list-group list-group-flush">
      ...
      <a href="<?php echo e($url ? $url: ""); ?>"
        class="list-group-item list-group-item-action list-group-item-info">Módulo 2: Ejemplos de negocios, criptomonedas, NFT.</a>
      <a href="<?php echo e($url ? $url: ""); ?>" class="list-group-item list-group-item-action list-group-item-info">Módulo 3: NN</a>
...
</html><?php /**PATH C:\xampp\htdocs\teduprincipal - proyecto_pruebas\resources\views\Mantenimiento\Cursos\cursoblockchain.blade.php ENDPATH**/ ?>