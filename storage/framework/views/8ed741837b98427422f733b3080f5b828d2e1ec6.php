...
<head>
  ...
  <link rel="icon" href="<?php echo e(asset('/images/TEDU-ICO.ico')); ?>">
   ...
   <title>Curso Emprendimientos TEDÜ</title>
</head>
  <!-- TOP NAV -->
...
<h1 class="title p-1 fs-1" align="center">Indice de Módulos del Curso de Emprendimientos <span class="text-danger">TEDÜ<span /></h1>
  ...
  <div class="container" id="si">
    <div class="list-group list-group-flush">
      ...
      <a href="https://academia.teduemprende.com/course/view.php?id=26#section-2" class="list-group-item list-group-item-action list-group-item-info">Módulo 1: Fundamentos del emprendimiento e identificación de problemas.</a>
      <a href="https://academia.teduemprende.com/course/view.php?id=26#section-3"
        class="list-group-item list-group-item-action list-group-item-info">Módulo 2: Entendiendo a los clientes.</a>
      <a href="https://academia.teduemprende.com/course/view.php?id=26#section-4" class="list-group-item list-group-item-action list-group-item-info">Módulo 3: Diseñando la oferta modelo de negocio.</a>
      <a href="https://academia.teduemprende.com/course/view.php?id=26#section-5"
        class="list-group-item list-group-item-action list-group-item-info">Módulo 4: Desarrollar y probar el producto o servicio.</a>
        <a href="https://academia.teduemprende.com/course/view.php?id=26#section-6"
        class="list-group-item list-group-item-action list-group-item-info">Módulo 5: Formalizando el plan de negocio.</a>
    </div>
  </div>
...
</html><?php /**PATH C:\xampp\htdocs\teduprincipal - proyecto_pruebas\resources\views\Mantenimiento\Cursos\cursoemprendimiento.blade.php ENDPATH**/ ?>