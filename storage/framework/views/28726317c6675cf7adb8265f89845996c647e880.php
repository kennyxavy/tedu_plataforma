...
<div class="row">
    ...
    <div class="card card-primary">
        ...
        <form  role="form" method="POST" action="<?php echo e(route('recargas.crear.nuevo')); ?>" accept-charset="UTF-8" enctype="multipart/form-data">
          <?php echo csrf_field(); ?>
          <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="input-group-prepend">
                                ...
                                <input type="text" class="form-control" id="detalle" name="detalle" value="<?php echo e(old('detalle')); ?>" placeholder="Ingrese detalle de solicitud" maxlength="100" required>
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="input-group-prepend">
                                ...
                                <input type="text" class="form-control" id="procedencia" name="procedencia" value="<?php echo e(old('procedencia')); ?>" placeholder="Banco procedencia" maxlength="100" required>
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="input-group-prepend">
                                ...
                                <input type="text" class="form-control" id="costo" name="costo" value="<?php echo e(old('costo')); ?>" placeholder="Ingrese valor" maxlength="100" required>
                        ...
                        <div class="col-sm-12">
                            ...
                            <small>Por favor, adjuntar el documento o imagen del comprobante de transferencia o deposito.</small>
