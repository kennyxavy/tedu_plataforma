...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('/css/academy_tedu.css')); ?>">
...
<section class="memberships" id="memberships">
    <div class="row">
        ...
        <div class="col50">
            <div class="imgBx">
                <img src="<?php echo e(asset('/images/academy_image.png')); ?>" alt="image1">
            </div>
        </div>
    </div>
    <br>
    <div class="title">
        ...
        <a href="<?php echo e(route('listacursos')); ?>"  class="text-danger"  >Quiero saber mas</a>
    </div>
</section>
...
</html><?php /**PATH C:\xampp\htdocs\teduprincipal - proyecto_pruebas\resources\views\Mantenimiento\Cursos\academia.blade.php ENDPATH**/ ?>