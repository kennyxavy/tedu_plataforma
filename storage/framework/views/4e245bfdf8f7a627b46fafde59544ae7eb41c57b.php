...
<head>
  ...
  <link rel="icon" href="<?php echo e(asset('/images/TEDU-ICO.ico')); ?>">
   ...
   <title>Curso Seguros TEDÜ</title>
</head>
  <!-- TOP NAV -->
...
<h1 class="title p-1 fs-1" align="center">Indice de Módulos del Curso de Seguros <span class="text-danger">TEDÜ<span /></h1>
  ...
  <div class="container" id="si">
    <div class="list-group list-group-flush">
      ...
      <a href="<?php echo e($url ? $url : "https://academia.teduemprende.com/course/view.php?id=18#section-0"); ?> class="list-group-item list-group-item-action list-group-item-info">Módulo 1: Generalidades</a>
      <a href="<?php echo e($url ? $url: "https://academia.teduemprende.com/course/view.php?id=18#section-0"); ?>

        class="list-group-item list-group-item-action list-group-item-info">Módulo 2: Ejemplos de negocios.</a>
      <a href="<?php echo e($url ? $url: "https://academia.teduemprende.com/course/view.php?id=18#section-0"); ?> class="list-group-item list-group-item-action list-group-item-info">Módulo 3: TEDU SEGUROS</a>
...
</html><?php /**PATH C:\xampp\htdocs\teduprincipal - proyecto_pruebas\resources\views\Mantenimiento\Cursos\cursoseguros.blade.php ENDPATH**/ ?>