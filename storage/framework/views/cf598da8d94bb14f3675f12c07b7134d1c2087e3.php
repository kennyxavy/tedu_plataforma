...
<h1 class="title p-1 fs-1" align="center">Indice de Módulos del Curso de ventas<span class="text-danger"> TEDÜ<span /></h1>
 ...
 <div class="container" id="si">
    <div class="list-group list-group-flush">
      ...
      <a href="https://academia.teduemprende.com/course/view.php?id=24#section-2" class="list-group-item list-group-item-action list-group-item-info">Módulo 1: Fundamentos profesionales de la venta.</a>
      <a href="https://academia.teduemprende.com/course/view.php?id=24#section-3"
        class="list-group-item list-group-item-action list-group-item-info">Módulo 2: Gestión efectiva de ventas.</a>
      <a href="https://academia.teduemprende.com/course/view.php?id=24#section-4" class="list-group-item list-group-item-action list-group-item-info">Módulo 3: Fundamentos biológicos venta.</a>
      <a href="https://academia.teduemprende.com/course/view.php?id=24#section-5"
        class="list-group-item list-group-item-action list-group-item-info">Módulo 4: Fundamentos psicológicos y sociales en ventas.</a>
        <a href="https://academia.teduemprende.com/course/view.php?id=24#section-6"
        class="list-group-item list-group-item-action list-group-item-info">Módulo 5: Capacidades y estrategias de ventas</a>
        <a href="https://academia.teduemprende.com/course/view.php?id=24#section-7"
        class="list-group-item list-group-item-action list-group-item-info">Módulo 6: Técnicas y procedimientos de ventas.</a>
        <a href="https://academia.teduemprende.com/course/view.php?id=24#section-8"
        class="list-group-item list-group-item-action list-group-item-info">Módulo 7: Fundamentos del marketing en procesos efectivos de venta. </a>
        <a href="https://academia.teduemprende.com/course/view.php?id=24#section-9"
        class="list-group-item list-group-item-action list-group-item-info">Módulo 8: Proceso de venta digital.</a>
        <a href="https://academia.teduemprende.com/course/view.php?id=24#section-10"
        class="list-group-item list-group-item-action list-group-item-info">Módulo 9: Proceso de venta en redes sociales.</a>
        <a href="https://academia.teduemprende.com/course/view.php?id=24#section-11"
        class="list-group-item list-group-item-action list-group-item-info">Módulo 10: Fundamentos del Customer Relationship Managment (CRM) </a>
        <a href="https://academia.teduemprende.com/course/view.php?id=24#section-12"
        class="list-group-item list-group-item-action list-group-item-info">Módulo 11: Funcionalidades del CRM </a>
    </div>
  </div>
...
</html><?php /**PATH C:\xampp\htdocs\teduprincipal - proyecto_pruebas\resources\views\Mantenimiento\Cursos\cursoventas.blade.php ENDPATH**/ ?>