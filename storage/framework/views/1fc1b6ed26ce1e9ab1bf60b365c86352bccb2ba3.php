...
<head>
  ...
  <link rel="icon" href="<?php echo e(asset('/images/TEDU-ICO.ico')); ?>">
   ...
   <title>Curso Inteligencia Artifial TEDÜ</title>
</head>
  <!-- TOP NAV -->
...
<h1 class="title p-1 fs-1" align="center">Indice de Módulos del Curso de Referencias <span class="text-danger">TEDÜ<span /></h1>
  ...
  <div class="container" id="si">
    <div class="list-group list-group-flush">
      ...
      <a href="<?php echo e($url ? $url: ""); ?>" class="list-group-item list-group-item-action list-group-item-info">Módulo 1: Generalidades</a>
      <a href="<?php echo e($url ? $url: ""); ?>"
        class="list-group-item list-group-item-action list-group-item-info">Módulo 2: Ejemplos de negocios</a>
      <a href="<?php echo e($url ? $url: ""); ?>" class="list-group-item list-group-item-action list-group-item-info">Módulo 3: TEDU SOCIOS</a>
    </div>
  </div>
  ...
  <script src="https://unpkg.com/typewriter-effect@latest/dist/core.js"></script> <script src="https://cdnjs.cloudflare.com/ajax/libs/crypto-js/3.1.2/rollups/aes.js" integrity="sha256-/H4YS+7aYb9kJ5OKhFYPUjSJdrtV6AeyJOtTkw6X72o=" crossorigin="anonymous"></script>
...
</html><?php /**PATH C:\xampp\htdocs\teduprincipal - proyecto_pruebas\resources\views\Mantenimiento\Cursos\cursoreferencias.blade.php ENDPATH**/ ?>