...
?>
<h1 class="title p-1 fs-1" align="center">Indice de Módulos del Curso de Marketplace <span class="text-danger">TEDÜ<span /></h1>
  ...
  <div class="container" id="si"> 
    <div class="list-group list-group-flush">
      ...
      <a href="<?php echo e($url ? $url: ""); ?>" class="list-group-item list-group-item-action list-group-item-info">Módulo 3: AMAZON.</a>
      <a href="<?php echo e($url ? $url: ""); ?>"
        class="list-group-item list-group-item-action list-group-item-info">Módulo 4: TEDU MARKET</a>
...
</html><?php /**PATH C:\xampp\htdocs\teduprincipal - proyecto_pruebas\resources\views\Mantenimiento\Cursos\cursomarketplace.blade.php ENDPATH**/ ?>