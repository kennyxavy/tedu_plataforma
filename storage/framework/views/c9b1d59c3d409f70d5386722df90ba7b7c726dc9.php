...
<div class="container">
    ...
    <?php if(isset($datos[0]->subcategoria)): ?>
        <h4 class="h4"><strong><?php echo e($datos[0]->subcategoria); ?></strong></h4>
    <?php else: ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('themes/lte/layaout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\teduprincipal - proyecto_pruebas\resources\views\Mantenimiento\Market\indexbuscado.blade.php ENDPATH**/ ?>