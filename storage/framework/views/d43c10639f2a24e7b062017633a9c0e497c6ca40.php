...
<div class="row justify-content-center">
    ...
    <div class="card card-primary">
        ...
        <form  role="form" method="POST" action="<?php echo e(route('envios.editar.nuevo')); ?>">
          <?php echo csrf_field(); ?>
          <div class="card-body">
                        ...
                        <div class="col-sm-5">
                            ...
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    ...
                                    <input type="hidden" name="idenvio" id="idenvio" value="<?php echo e($datos[0]->id); ?>">
                                    <input type="text" class="form-control" id="destino" name="destino" value="<?php echo e($datos[0]->destino); ?>" placeholder="Destino" >
                            </div>
                        </div>
                        <div class="col-sm-3">
                            ...
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    ...
                                    <input type="text" class="form-control" id="precio" name="precio" value="<?php echo e($datos[0]->precio); ?>" placeholder="">
                            </div>
                        </div>
                        <div class="col-sm-2">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('themes/lte/layaout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\teduprincipal - proyecto_pruebas\resources\views\Mantenimiento\Envios\editar.blade.php ENDPATH**/ ?>